# Generated by Django 5.0.6 on 2024-05-29 01:59
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateTimeField(default=django.utils.timezone.now)),
                ('product', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='p_images', to='Food_Zone.product')),
            ],
        ),
        migrations.CreateModel(
            name='Sub_Category',
            fields=[
                ...
                ('date', models.DateTimeField(default=django.utils.timezone.now)),
                ('category', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='sub_categories', to='Food_Zone.category')),
            ],
        ),
        migrations.AddField(
            model_name='product',
            name='sub_category',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='sub_category', to='Food_Zone.sub_category'),
        ),
        migrations.AddField(
            model_name='product',
            name='vendor',
            field=models.ForeignKey(default='Food Zone', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='vendor', to='Food_Zone.vendor'),
        ),
        migrations.CreateModel(
            name='Users',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='Food_Zone.product')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='reviews', to='Food_Zone.product')),
